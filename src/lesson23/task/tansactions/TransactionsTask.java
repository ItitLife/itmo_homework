package lesson23.task.tansactions;
...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        Map<String, Long> transMap = transactionStream
                .collect(Collectors.groupingBy(transaction -> transaction.getAccount().getNumber(), Collectors.counting()));
        System.out.println(transMap);
        // TODO:: 2. найти общую сумму транзакций по по всем аккаунтам
        // System.out.println(transactionStream.count());
        long sum = 0;
        for (long lng : transMap.values()) sum += lng;
